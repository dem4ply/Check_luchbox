...
{
	public String date, str_dinner_room, str_food;
	public int food, type_food, dinner_room;
	
	public struc_Param_login(String date, int food, int type_food, int dinner_room, String str_dinner_room, String str_food)
	{
		this.date = date;
		this.food = food;
